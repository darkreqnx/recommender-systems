...
def computeSVD(urm, K, index):

    U, s, Vt = getSVD(urm, K, index)
...
def main():
    ...
    # print('Computing SVD...')
    # U, S, Vt = computeSVD(urm, K, MAX_UID)
    # print(S)
    # uTest = computeEstimatedRatings(
    # urm, U, S, Vt, users, moviesSeen, K, True)
